...
public final class SizeUtils {
    ...
    /**
     * 宽度 * 比例 = 控件高度
     * @param hwScale 组件或控件高宽比
     * @param minusWidth 屏幕宽度要减去的宽度
     * @return
     */
    /*public static int getHeight(double hwScale,int minusWidth){
        //宽度
        int width = ScreenUtils.getScreenWidth() - minusWidth;
        //宽度 * 比例
        int height = (int)(width * hwScale + 0.5f);
        return height;
    }*/
