...
public class RealPathFromUriUtil {
    ...
    public static String getRealPathFromUri(Context context, Uri uri) {
        ...
        }//        int sdkVersion = Build.VERSION.SDK_INT;//        if
        // (sdkVersion < 11) {//            // SDK < Api11//
        // return getRealPathFromUri_BelowApi11(context, uri);//        }////
        // if (sdkVersion < 19) {////             SDK > 11 && SDK < 19////
        // return getRealPathFromUri_Api11To18(context, uri);//
    ...
    /**
     * 针对图片URI格式为Uri:: file:///storage/emulated/0/DCIM/Camera
     * /IMG_20170613_132837.jpg
     *
     * @param context
     * @param uri
     * @return
     ...
     */
    @SuppressLint("NewApi")
    private static String getRealPathFromUri_AboveApi19(Context context,
                                                        Uri uri) {
        ...
        Cursor cursor = context
                .getContentResolver().query(MediaStore.Images
     ...
     */
    private static String getRealPathFromUri_BelowApi11(Context context,
                                                        Uri uri) {
        String filePath = null;
        String[] projection = {MediaStore.Images.Media.DATA};
