...
import com.haoniu.quchat.video.util.PhoneStateManager;
...
public class VoiceCallActivity extends CallActivity implements OnClickListener {
    ...
    private View hangupBtn, bar;
    private View refuseBtn;
    private View answerBtn;
    private ImageView muteImage, imgHead;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        refuseBtn = (View) findViewById(R.id.btn_refuse_call);
        answerBtn = (View) findViewById(R.id.btn_answer_call);
        hangupBtn = (View) findViewById(R.id.btn_hangup_call);
        bar = (View) findViewById(R.id.bar);

        muteImage = (ImageView) findViewById(R.id.iv_mute);
        imgHead = (ImageView) findViewById(R.id.swing_card);
        ...
        GlideUtils.GlideLoadCircleErrorImageUtils(this, user.getAvatar(), imgHead, R.mipmap.img_default_avatar);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.iv_handsfree:
                if (isHandsfreeState) {
                    handsFreeImage.setImageResource(R.mipmap.mt);
                    closeSpeakerOn();
                    isHandsfreeState = false;
                } else {
                    handsFreeImage.setImageResource(R.mipmap.mtdianji);
                    openSpeakerOn();
